...
namespace HREngine.Bots
{
	class Sim_EX1_345 : SimTemplate //* Mindgames
	{
        ...
        Chireiden.Silverfish.SimCard copymin = CardDB.Instance.getCardDataFromID(Chireiden.Silverfish.SimCard.CS2_182); // we take a icewindjety :D

		public override void onCardPlay(Playfield p, bool ownplay, Minion target, int choice)
		{
            if (p.enemyDeckSize < 1) copymin = CardDB.Instance.getCardDataFromID(Chireiden.Silverfish.SimCard.EX1_345t); // Shadow of Nothing
