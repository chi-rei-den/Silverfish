	...
	class Sim_NAX9_04H : SimTemplate //* Sir Zeliek
	{
        ...
        public override void onAuraStarts(Playfield p, Minion own)
        {
            if (own.own)
            {
                ...
                {
                    int bonus = (p.ownWeapon.card.cardIDenum == CardIds.NonCollectible.Neutral.RunebladeHeroic) ? 6 : 3;
            ...
            else
            {
                ...
                {
                    int bonus = (p.enemyWeapon.card.cardIDenum == CardIds.NonCollectible.Neutral.RunebladeHeroic) ? 6 : 3;
